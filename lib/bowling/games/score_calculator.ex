defmodule Bowling.Games.ScoreCalculator do
  ...
  defp do_calculate([[10, thrown_1] | _tail], scores) do
    scores
  end
  ...
  defp do_calculate([[thrown_1, thrown_2], [next_thrown_1, next_thrown_2] | tail], scores) when thrown_1 + thrown_2 == 10 do
    new_scores = scores ++ [thrown_1 + thrown_2 + next_thrown_1]
    do_calculate([[next_thrown_1, next_thrown_2] | tail], new_scores)
  end

  defp do_calculate([[thrown_1, thrown_2], [next_thrown_1] | tail], scores) when thrown_1 + thrown_2 == 10 do
    new_scores = scores ++ [thrown_1 + thrown_2 + next_thrown_1]
